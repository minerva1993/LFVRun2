...
void plots_flav_hadron(){

  setTDRStyle();

  TFile * file = new TFile("f_flav.root");

  makePlot_hadron(file,"h_Jet_btagDeepFlavB_b","h_Jet_btagDeepFlavB_c","h_Jet_btagDeepFlavB_lf");
  makePlot_hadron(file,"h_Jet_btagDeepFlavC_b","h_Jet_btagDeepFlavC_c","h_Jet_btagDeepFlavC_lf");
  makePlot_hadron(file,"h_Jet_btagDeepFlavLF_b","h_Jet_btagDeepFlavLF_c","h_Jet_btagDeepFlavLF_lf");
