...
void makePlot_hadron_flav(TFile * f, TString b, TString c, TString lf, float x1=0, float x2=10, float y1=0, float y2=300){
...
void plots_hadron_flav(){

  setTDRStyle();

  TFile * file = new TFile("f_DeepFlav_2018.root");

  makePlot_hadron_flav(file,"h_DeepFlavB_b","h_DeepFlavB_c","h_DeepFlavB_lf");
}
