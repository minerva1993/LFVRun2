...
//				     .Define("goodjets_idx",goodjets_idx,{"goodjets"});
  ...
  auto df_S1_hadronFlav = df_S1_goodtau.Define("good_hadron_Flav","Jet_hadronFlavour[goodjets]")
...
//                                       .Define("good_lf_hadron_idx",good_lf_hadron_idx,{"good_lf_hadron"});
  ...
  auto df_S1_Deep_hadron = df_S1_hadronFlav.Define("DeepB_b", "Jet_btagDeepB[good_b_hadron]")
  ...
  auto h_hadronFlav = df_S1_Deep_hadron.Histo1D({"h_hadronFlav", "h_hadronFlav",10, 0,10}, "good_hadron_Flav");
  ...
  auto h_leading_good_b_hadron_pt = df_S1_good_b_hadron.Define("leading_good_b_hadron_pt","Jet_pt[good_b_hadron][0]")
				  .Histo1D({"h_leading_good_b_hadron_pt","leading_good_b_hadron_pt",20, 0, 200}, "leading_good_b_hadron_pt");
  auto h_leading_good_c_hadron_pt = df_S1_good_c_hadron.Define("leading_good_c_hadron_pt","Jet_pt[good_c_hadron][0]")
                                  .Histo1D({"h_leading_good_c_hadron_pt","leading_good_c_hadron_pt",20, 0, 200}, "leading_good_c_hadron_pt");
  auto h_leading_good_lf_hadron_pt = df_S1_good_lf_hadron.Define("leading_good_lf_hadron_pt","Jet_pt[good_lf_hadron][0]")
                                  .Histo1D({"h_leading_good_lf_hadron_pt","leading_good_lf_hadron_pt",20, 0, 200}, "leading_good_lf_hadron_pt");
